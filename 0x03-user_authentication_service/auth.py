...
class Auth:
    ...
    def register_user(self, email: str, password: str) -> User:
        ...
        Returns:
            User: The newly created user if no user with the given email exists.
        Raises:
    ...
    def create_session(self, email: str) -> Union[None, str]:
        """
        Create a session_id for an existing user and update the user's session_id attribute.
        Args:
            email (str): The user's email address.
        Returns:
            Union[None, str]: The session_id if created, else None.
        """
        try:
            user = self._db.find_user_by(email=email)
        except NoResultFound:
    ...
    def get_user_from_session_id(self, session_id: str) -> Union[None, U]:
        """
        Retrieve a user based on session_id.
        Args:
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        ...
        Args:
            reset_token (str): The reset token issued for password reset.
